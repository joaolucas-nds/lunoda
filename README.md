...
lunoda_vN_guide.md       # guias passo a passo de cada versão (memória da evolução)

# Sistema de documentação de contexto (para desenvolvimento entre sessões)
...
logs/AAAA-MM-DD.md       # logs de sessão
```

## Desenvolvimento

Cada versão evolui por um **guia `.md` passo a passo** (`lunoda_vN_guide.md`), aplicado manualmente ao HTML — não por edição direta. Ver `DECISIONS.md` (DEC-002) e `HISTORY.md` para o fluxo completo.
